...
function Projectsection(props) {
  ...
  const roes1 = () => {
    for (let i = 0; i < datacardindex.length; i++) {
      rows.push(
        createData(
          datacardindex[i]?.projectsunion[0].cardname,
          datacardindex[i]?.projectsunion[0].cardcode,
      ...
      <div dir="rtl">
        <Table aria-label="collapsible table">
          <TableHead>
            <TableRow>
              <TableCell />
              <TableCell align="center">סעיף </TableCell>
              <TableCell align="center">קוד סעיף </TableCell>
